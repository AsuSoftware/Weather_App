...
class WeatherInfo {
    ...
    createError() {
        ...
        const textError = document.createTextNode("Opps! pagina non trovata");
        ...
        const textDescription = document.createTextNode(
            "Sembra che la pagina non sia stata trovata perché potresti aver digitato la posizione errata o il server non risponde in questo momento"
        );
    ...
    createFormBody() {
        ...
        const titleText = document.createTextNode("Benvenuto nell'app Meteo");
        title.appendChild(titleText);
        form.appendChild(title);
        const titleName = this.createElements("h2", "title-name");
        const textTitleName = document.createTextNode("Come ti chiami?");
        ...
        const textTitleLocation = document.createTextNode("Qual è la tua posizione?");
